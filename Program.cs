...
builder.Services.AddScoped<ILichLamViecServices,  LichLamViecServices>();
builder.Services.AddScoped<ILichlamViecRepository, LichLamViecRepository>();
builder.Services.AddScoped<IDangKyCaLamViecService, DangKyCaService>();
builder.Services.AddScoped<IDangKyCaLamRepository, DangKyCaLamRepository>();
